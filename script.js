document.addEventListener('DOMContentLoaded', function() {
    const clues = [
        ...
        { clue: '<audio controls><source src="clue.m4a" type="audio/m4a">Your browser does not support the audio element.</audio><p>Find Max on the Second Floor of this Flinders Street Icon</p>', answer: "Tower" },
