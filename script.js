document.addEventListener('DOMContentLoaded', function() {
    const clues = [
        ...
        { clue: '<audio controls><source src="clue.mp3" type="audio/mp3">Your browser does not support the audio element.</audio><p>Find Max on the Second Floor of this Flinders Street Icon</p>', answer: "Tower" },
        { clue: '<img src="Triangle.png" alt="Clue Picture - Msg Lucas if you cant see it"><p>Take a Shot at Triangulating these Locations - where are you?</p>', answer: "Shot Tower" },
